...
The GBM model is significantly better than the regression tree model with an accuracy of `r paste(round(AccuracyRPART*100,2),"%")` on the testing dataset. All things being equal, we would expect similar performance on the out-of-sample test set. 
